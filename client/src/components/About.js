                    ...
                    <div className="featureContainer">
                        <div className="featureBox">
                            <div className="featureImage">
                                <svg class="bi bi-text-left" width="64" height="64" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="featureBox">
                            <div className="featureImage">
                                <svg class="bi bi-eye-fill" width="64" height="64" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="featureBox">
                            <div className="featureImage">
                                <svg class="bi bi-bar-chart-fill" width="64" height="64" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="featureBox">
                            <div className="featureImage">
                                <svg class="bi bi-clock-history" width="64" height="64" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
